    ...
    return (
        <div>
            <div className="min-h-[88.5vh] bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-size-[20px_20px] text-white">
                ...
                <p className="text-center text-gray-400">Please fill in the details below to register Your organization</p>
                    ...
                    <div className="space-y-12">
                        <div className="pb-5">
                            <div className="mt-10">
                                {/* For Organization  */}
                                <div>
                                    <label htmlFor="organization" className="block text-sm/6 font-medium text-white">Organization Name</label>
                                    <div className="my-2">
                                        <div className="flex items-center rounded-md bg-white/5 pl-3 outline-1 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500">
                                            <input id="organization"  type="text" name='organization' className="block min-w-0 grow bg-transparent py-1.5 pr-3 pl-1 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6" />
                                        </div>
                                    </div>
                                </div>
                                {/* For name  */}
